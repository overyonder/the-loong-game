...
The ladder measures our bots against each other. The next two tools look outward, at everyone else's games: first a sampler that downloads the public ladder's replays without loading the organisers' site, then a decoder that reads them.
